...
and maintainable solutions with minimal process overhead.
...
- Use SOLID and DRY when they improve maintainability in a concrete way.

# Workflow

- Make reasonable assumptions and keep momentum unless a decision is risky or irreversible.
- Prefer the existing project conventions over introducing new structure.
- Suggest lightweight follow-ups only when they clearly reduce future risk.
